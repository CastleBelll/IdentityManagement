...
import com.example.TestProject.auth.service.CustomUserDetailsService;
...
public class JwtTokenFilter extends OncePerRequestFilter {
    ...
    private UsernamePasswordAuthenticationToken getAuthenticationFromToken(String token) {
        Long userNum = jwtTokenProvider.getUserIdFromToken(token);
        UserDetails userDetails = customUserDetailsService.loadUserByUserNum(userNum);
